...
$.fn.codaSlider = function(settings) {
	...
	return this.each(function(){
		...
		if (location.hash && parseInt(location.hash.slice(1)) != -1) {
		...
		container.each(function(i) {
			...
			$("div#stripNav" + j + " a").each(function(z) {
				...
				$(this).bind("click", function() {
					...
					cPanel = z + 1;
					$(this).parent().parent().parent().next().find("div.panelContainer").animate({ left: cnt}, settings.easeTime, settings.easeFunc);
				});
			});
