    ...
    var ContactForm = Backbone.Model.extend({
        ...
        validators: {
            ...
            isEmail: function(value) {
                ...
                return ContactForm.prototype.validators.pattern(value, ContactForm.prototype.patterns.email);

            },

            isPhone: function(value) {

                return ContactForm.prototype.validators.pattern(value, ContactForm.prototype.patterns.phone);

            },

            hasSpecialCharacter: function(value) {

                return ContactForm.prototype.validators.pattern(value, ContactForm.prototype.patterns.specialCharacters);

            },

            hasDigit: function(value) {

                return ContactForm.prototype.validators.pattern(value, ContactForm.prototype.patterns.digits);
